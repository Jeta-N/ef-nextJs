...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, faMountainCity, faCity, faCartShopping, faGift } from '@fortawesome/free-solid-svg-icons'
